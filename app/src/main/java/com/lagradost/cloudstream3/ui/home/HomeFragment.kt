...
class HomeFragment : BaseFragment<FragmentHomeBinding>(
    ...
    private val apiChangeClickListener = View.OnClickListener { _ ->
        // No-op: single provider mode
    }
    ...
    override fun onBindingCreated(binding: FragmentHomeBinding) {
        ...
        binding.apply {
            ...
            homePreviewReloadProvider.isVisible = false
            homePreviewSettingsButton.isVisible = false
