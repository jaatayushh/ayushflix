...
class SearchFragment : BaseFragment<FragmentSearchBinding>(
    ...
    override fun onBindingCreated(
        ...
        selectedApis = (allAvailableApis + listOf("Netflix", "NetflixM", "Netflix Mirror", "Prime Video", "PrimeVideoM", "Prime Video Mirror", "Hotstar", "HotstarM", "HotStar Mirror", "Disney", "DisneyM", "Disney+ Mirror", "Disney Studio", "Castle Tv", "Castle TV", "Castle TV (Use VLC)", "CastleTvProvider")).toMutableSet()
        binding.searchFilter.isVisible = false

        val settingsManager = context?.let { PreferenceManager.getDefaultSharedPreferences(it) }
        val isAdvancedSearch = settingsManager?.getBoolean("advanced_search", false) ?: false
        ...
        if (!isLayout(PHONE)) {
            binding.searchFilter.isFocusable = false
            binding.searchFilter.isFocusableInTouchMode = false
        }
