...
## ⚡ Direct Download (v1.0.7)

| Platform | Format | Size | Architecture | Direct Download |
| :--- | :---: | :---: | :---: | :---: |
| 📱 **Android Smartphone / Tablet** | `.apk` | **~50 MB** | `arm64-v8a`, `armeabi-v7a`, `x86_64` | [**Download Ayushflix-v1.0.7.apk**](https://github.com/jaatayushh/ayushflix/releases/download/v1.0.7/Ayushflix-v1.0.7.apk) |
| 📺 **Android TV / Google TV / FireStick** | `.apk` | **~50 MB** | Native 10-Foot Leanback UI | [**Download Ayushflix-v1.0.7.apk**](https://github.com/jaatayushh/ayushflix/releases/download/v1.0.7/Ayushflix-v1.0.7.apk) |
| 🖥️ **Windows 10 / 11 (WSA / Emulator)** | `.apk` | **~50 MB** | Native Desktop Window | [**Download Ayushflix-v1.0.7.apk**](https://github.com/jaatayushh/ayushflix/releases/download/v1.0.7/Ayushflix-v1.0.7.apk) |
...
```powershell
Invoke-WebRequest -Uri "https://github.com/jaatayushh/ayushflix/releases/download/v1.0.7/Ayushflix-v1.0.7.apk" -OutFile "$env:TEMP\Ayushflix.apk"
...
2. Download [**Ayushflix-v1.0.7.apk**](https://github.com/jaatayushh/ayushflix/releases/download/v1.0.7/Ayushflix-v1.0.7.apk).
...
1. Download [**Ayushflix-v1.0.7.apk**](https://github.com/jaatayushh/ayushflix/releases/download/v1.0.7/Ayushflix-v1.0.7.apk).
...
1. **Method A (Send Files to TV)**:
   ...
   - Send `Ayushflix-v1.0.7.apk` to your TV and install using a file manager (e.g., *File Commander*).
2. **Method B (USB Drive)**:
   - Copy `Ayushflix-v1.0.7.apk` onto a FAT32/NTFS formatted USB flash drive.
...
3. **Method C (Downloader App)**:
   ...
   - Enter the direct release URL: `https://github.com/jaatayushh/ayushflix/releases/download/v1.0.7/Ayushflix-v1.0.7.apk` to download and install.
...
3. The compiled APK will be located at:
   ```
   app/build/outputs/apk/stable/release/Ayushflix-v1.0.7.apk
   ```
